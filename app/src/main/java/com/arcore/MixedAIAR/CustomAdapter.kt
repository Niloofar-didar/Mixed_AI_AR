...
class CustomAdapter(private val mList: List<ItemsViewModel>, val streamSource: BitmapSource, val activity: Activity) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
     // create new views
