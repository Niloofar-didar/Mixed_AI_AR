 ...
 */
public class ImageClassifier_Inception_V3_Quantized_299 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifier_Inception_V3_Quantized_299(Activity activity) throws IOException {
    super(activity);
