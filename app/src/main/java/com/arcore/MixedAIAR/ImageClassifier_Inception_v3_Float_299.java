...
public class ImageClassifier_Inception_v3_Float_299 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifier_Inception_v3_Float_299(Activity activity) throws IOException {
    super(activity);
  ...
  protected String getLabelPath() {
    return "labels_inception_v3.txt";
  }
